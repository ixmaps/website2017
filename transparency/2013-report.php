...
<div class="content">
    ...
    <section id="download">
        <article>
            <a href="/docs/DataPrivacyTransparencyofCanadianISPs-2013.pdf" target="_blank" class="download-button"><button>Download the Full 2013 Report</button></a>
    ...
    <article id="contents">
        ...
        <section id="recommendations">
            ...
            <ol class="notes">
                ...
                <li id="fn3">Star ratings can also be reviewed for particular internet routings and carriers on the <a href="https://ixmaps.ca/explore">Explore page of the IXmaps website</a>. <a class="returntoarticle" href="#fn3-inline">↩</a></li>
