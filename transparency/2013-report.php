    ...
    <article id="contents">
        ...
        <section id="recommendations">
            ...
            <ol class="notes">
                ...
                <li id="fn3">Star ratings can also be reviewed for particular internet routings and carriers on the <a href="https://ixmaps.ca/map.php">Mapping page of the IXmaps website</a>. <a class="returntoarticle" href="#fn3-inline">↩</a></li>
